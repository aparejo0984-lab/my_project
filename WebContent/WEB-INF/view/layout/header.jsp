<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
  <head>
    ...
    <!-- owl carousel-->
    <link rel="stylesheet" href="<c:url value="/resources/vendor/owl.carousel/assets/owl.carousel.css" />">
    
    <link rel="stylesheet" href="<c:url value="/resources/vendor/owl.carousel/assets/owl.theme.default.css" />">
    <!-- theme stylesheet-->
