            ...
            <div id="checkout" class="col-lg-9">
              <div class="box">
				...
				<ul class="nav nav-pills nav-fill">
				   ...
				   <li class="nav-item"><a href="<%=request.getContextPath()%>/checkout-delivery" class="nav-link active"><i class="fa fa-truck"></i><br>Delivery Method</a></li>
				   ...
				   <li class="nav-item"><a href="<%=request.getContextPath()%>/checkout-review" class="nav-link"><i class="fa fa-eye"></i><br>Order Review</a></li>
				</ul>
                  <div class="content">
                    <div class="row">
                      <div class="col-sm-6">
