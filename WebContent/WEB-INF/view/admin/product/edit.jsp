        ...
        <div class="container">
          <div class="row bar mb-0">
            <div id="customer-orders" class="col-md-9">
                ...
                <form:form modelAttribute="product" action='<%=request.getContextPath() + "/admin/product/update" %>' method="POST">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="name">Code</label>
                        <form:input path="code" class="form-control" readonly="true"></form:input>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
